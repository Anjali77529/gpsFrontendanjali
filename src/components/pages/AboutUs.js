                        ...
                        <div className="page-title">
                            ...
                            <div className="col-sm-12 col-md-6 text-right">
                                <ul className="breadcrumbs">
                                    ...
                                    <li><a href="#">about our projects</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
  ...
  const AboutBody = () => {
    ...
    <div className="col-md-6 col-sm-12 col-xs-12 ">
        <div className="about-title">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent congue justo scelerisque mattis iaculis. Maecenas vestibulum faucibus enim scelerisque egestas. Praesent facilisis, tortor vel vehicula imperdiet, felis massa ultrices metus, sed consectetur massa ex vitae sem. Integer eu sodales augue leo.</p>


            <p>Pellentesque pharetra orci quam, vel scelerisque massa semper et. Fusce vel tortor eu metus rhoncus blandit a vel turpis. Suspendisse sed facilisis lacus. Integer mattis interdum neque, non molestie risus facilisis et. Donec gravida luctus laoreet. Curabitur quis iaculis velit. </p>

            <div className="more-about margin-top-30"> <a href="#" className="btn btn-primary btn-lg">Contact Us <i className="fa fa-chevron-circle-right"></i></a> </div>
    ...
    <div className="col-md-6 col-sm-12 our-gallery col-xs-12">
        <a className="tt-lightbox" href="images/crew.png"> <img className="img-responsive" alt="Image" src="images/crew.png" /></a>
            ...
            <div className="col-md-7 col-sm-12 col-xs-12 ">
                ...
                <div className="choose-services">
                    <ul className="choose-list">
                      <li>
                        <div className="choose-box"> <span className="iconbox"><i className="flaticon-logistics-delivery-truck-and-clock"></i></span>
                      ...
                      <li>
                        <div className="choose-box"> <span className="iconbox"><i className="flaticon-woman-with-headset"></i></span>
                          <div className="choose-box-content">
                        ...
                        <li>
                            <div className="choose-box"> <span className="iconbox"><i className="flaticon-24-hours-symbol"></i></span>
                                <div className="choose-box-content">
                                    <h4>24/7 Support </h4>
                                    <p>Donec dignissim enim id urna fermentum, non hendrerit sem volutpat ellentesque pretium sapien nec metus.non hendrerit sem volutpat ellentesque pretium sapien nec metus</p>
                                </div>
            ...
            <div className="col-md-5 col-sm-12 col-xs-12">
                <div className="accordion-box style-one">
                    <div className="faqs-title">
                        ...
                        <p>Ut consequat velit a metus accumsan, vel tempor nulla blandit. Integer euismod magna vel mi congue suscipit.</p>
                    </div>
          
                    <div className="accordion accordion-block">
                        <div className="accord-btn active">
                            <h4>What is a freight forwarder ?</h4></div>
                        <div className="accord-content collapsed">
                            <p>Just sit right back and you'll hear a tale a tale of a fateful trip that started from this tropic port aboard this tiny ship all of them had hair of gold like their mother the youngest one in curls. Space. The final frontier.tortor vel vehicula imperdiet, felis massa ultrices metus, sed consectetur massa ex vitae sem. Integer eu sodales augue leo.</p>
                        </div>
                    </div>
              
                    <div className="accordion accordion-block">
                        <div className="accord-btn">
                            <h4>Why are the shipping rates so volatile ?</h4></div>
                    ...
                    <div className="accordion accordion-block">
                        <div className="accord-btn">
                            <h4>What are the methods of payment ?</h4></div>
                        <div className="accord-content">
                            <p>Just sit right back and you'll hear a tale a tale of a fateful trip that started from this tropic port aboard this tiny ship all of them had hair of gold like their mother the youngest one in curls. Space. The final frontier.</p>
                        </div>
                    </div>
        ...
        <div className="container">
            <div className="row clearfix">
                ...
                <div className="col-md-5 col-sm-12 col-xs-12 our-gallery">
                    <a className="tt-lightbox" href="images/about-company-1.png"> <img className="img-responsive margin-bottom-30" alt="Image" src="images/about-company-1.png" /></a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div className="row">
                <div className="col-xs-6 col-sm-3 col-md-3">
                    <div className="statistic-percent" data-perc="356">
                        <div className="facts-icons"> <span className="flaticon-woman-with-headset"></span> </div>
                ...
                <div className="col-xs-6 col-sm-3 col-md-3">
                    <div className="statistic-percent" data-perc="126">
                        <div className="facts-icons"> <span className="flaticon-commercial-delivery-symbol-of-a-list-on-clipboard-on-a-box-package"></span> </div>
                ...
                <div className="col-xs-6 col-sm-3 col-md-3">
                    <div className="statistic-percent" data-perc="274">
                        <div className="facts-icons"> <span className="flaticon-free-delivery-truck"></span> </div>
                ...
                <div className="col-xs-6 col-sm-3 col-md-3">
                    <div className="statistic-percent" data-perc="434">
                        <div className="facts-icons"> <span className="flaticon-ocean-transportation"></span> </div>
