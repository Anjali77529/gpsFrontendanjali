                ...
                <div className="accordion-box style-one">
                  ...
                  <div className="accordion accordion-block">
                    ...
                    <div className="accord-content collapsed">
                      <p>
                        ...
                        fateful trip that started from this tropic port aboard
                        this tiny ship all of them had hair of gold like their
                        mother the youngest one in curls. Space. The final
                        frontier.tortor vel vehicula imperdiet, felis massa
                        ultrices metus, sed consectetur massa ex vitae sem.
                        Integer eu sodales augue leo.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="accordion accordion-block">
                    <div className="accord-btn">
                      <h4>Why are the shipping rates so volatile ?</h4>
                    </div>
